...
public class QueryEngine {
    ...
    public void AnalyzedAppQuery() throws CypherException, IOException {
        ...
        try (Transaction ignored = graphDatabaseService.beginTx()) {
            result = graphDatabaseService.execute(
                    "MATCH (a:App) RETURN  a.app_key as app_key, " +
                            ...
                            "a.number_of_lines as number_of_lines");
    ...
    public void getAllNumberOfLines() throws IOException {
        getPropertyForAllApk("Method", "number_of_lines", "_ALL_NUMBER_OF_LINES.csv");
    }
